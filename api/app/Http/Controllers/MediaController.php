...
{
    private $repo, $service, $rivistaRepo, $userRepo;

    public function __construct(IMediaRepo $repo, IMediaService $service, IRivistaRepo $rivistaRepo, IUserRepo $userRepo)
    {
        $this->repo = $repo;
